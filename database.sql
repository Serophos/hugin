...
DROP TABLE IF EXISTS display_sync_releases;
DROP TABLE IF EXISTS display_cache_readiness;
...
CREATE TABLE display_cache_readiness (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE display_sync_releases (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
