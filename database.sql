...
('Compact Status Card', 'text', 'external', NULL, NULL, NULL, '# Simple by default\n\nRun Hugin on standard web clients, assign playlists to screens, and keep demo content professional, safe, and easy to replace.', '#1f2937', 'rgba(249,250,251,1)', 'rgba(31,41,55,0.78)', 'center', 'none', 560, 0, 0, 55, 'rgba(31,41,55,1)', 'rgba(249,250,251,1)', 'bottom-left', 10, 9, 'hide', 1);
