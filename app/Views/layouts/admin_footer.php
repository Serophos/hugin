...
<dialog class="admin-dialog" data-confirm-dialog aria-labelledby="admin-confirm-title" aria-describedby="admin-confirm-message">
    <form method="dialog" class="admin-dialog__panel">
        ...
        <div class="form-actions">
            ...
            <button type="button" class="button button--danger" data-confirm-accept data-alert-icon="<?= e(asset_url('/assets/icons/admin/cancel.svg')) ?>"><?= admin_icon('delete') ?><span data-default-label="<?= e(__('common.yes')) ?>" data-alert-label="<?= e(__('common.close')) ?>"><?= e(__('common.yes')) ?></span></button>
        </div>
    </form>
</dialog>
