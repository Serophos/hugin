...
<div class="card">
    ...
    <table>
        <thead><tr><th class="handle-col"></th><th><?= e(__('common.name')) ?></th><th><?= e(__('channel.default_label')) ?></th><th><?= e(__('channel.schedules_label')) ?></th><th><?= e(__('common.effect')) ?></th><th><?= e(__('channel.slides_count')) ?></th><th><?= e(__('common.status')) ?></th><th></th></tr></thead>
        ...
        <?php foreach ($group['channels'] as $channel): ?>
            <tr draggable="true" data-id="<?= e((string)$channel['channel_id']) ?>">
                <td class="handle">↕</td>
                <td><?= e($channel['channel_name']) ?></td>
                <td><?= e($channel['is_default'] ? __('common.yes') : __('common.no')) ?></td>
                <td><?= e((string)$channel['schedule_count']) ?></td>
