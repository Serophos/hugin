    ...
    <div class="card">
        <form method="post" action="<?= e($display ? url('/admin/displays/' . $display['id'] . '/edit') : url('/admin/displays/create')) ?>" class="form-grid">
            ...
            <label><?= e(__('display.human_url')) ?>
                <input type="text" id="display_slug" name="slug" value="<?= e((string)old('slug', $display['slug'] ?? '', $formId)) ?>" placeholder="<?= e(__('display.slug_placeholder')) ?>" required<?= field_attrs('slug', $formId, field_note_id('slug', $formId)) ?>>
