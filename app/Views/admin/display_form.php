        ...
        <form method="post" action="<?= e($display ? url('/admin/displays/' . $display['id'] . '/edit') : url('/admin/displays/create')) ?>" class="form-grid">
            ...
            <fieldset class="full-width">
                ...
                <label><?= e(__('display.vnc_username')) ?>
                    <input class="form-control" type="text" name="vnc_username" value="<?= e((string)old('vnc_username', $display['vnc_username'] ?? '', $formId)) ?>" autocomplete="off" maxlength="150" placeholder="<?= e(__('display.vnc_username_placeholder')) ?>"<?= field_attrs('vnc_username', $formId) ?>>
                    <?= field_error_html('vnc_username', $formId) ?>
                </label>
                <label><?= e(__('display.vnc_password')) ?> <?= $display ? '<span class="text-body-secondary muted">' . e(__('display.vnc_password_keep_hint')) . '</span>' : '' ?>
                    <input class="form-control" type="password" name="vnc_password" autocomplete="new-password" maxlength="255" placeholder="<?= e(__('display.vnc_password_placeholder')) ?>"<?= field_attrs('vnc_password', $formId) ?>>
