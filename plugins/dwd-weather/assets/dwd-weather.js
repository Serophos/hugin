(function () {
    ...
    function updateClock(container) {
        const now = new Date();
        const dateEl = container.querySelector('.dwd-weather-date');
        const timeEl = container.querySelector('.dwd-weather-time');
    ...
    function boot() {
        ...
        document.querySelectorAll('.dwd-weather-slide[data-weather-refresh-seconds]').forEach(function (el) {
