...
$setupI18n = [
    'no_field' => __('plugins.tl-1menu.setup.no_field'),
    'summary.rows' => __('plugins.tl-1menu.setup.summary.rows'),
    'summary.locations' => __('plugins.tl-1menu.setup.summary.locations'),
    'summary.food_types' => __('plugins.tl-1menu.setup.summary.food_types'),
    'summary.tokens' => __('plugins.tl-1menu.setup.summary.tokens'),
    'sections.field_mapping' => __('plugins.tl-1menu.setup.sections.field_mapping'),
    'sections.price_groups' => __('plugins.tl-1menu.setup.sections.price_groups'),
    'sections.locations' => __('plugins.tl-1menu.setup.sections.locations'),
    'sections.food_types' => __('plugins.tl-1menu.setup.sections.food_types'),
    'sections.tokens' => __('plugins.tl-1menu.setup.sections.tokens'),
    'sections.categories' => __('plugins.tl-1menu.setup.sections.categories'),
    'fields.id' => __('plugins.tl-1menu.setup.fields.id'),
    'fields.key' => __('plugins.tl-1menu.setup.fields.key'),
    'fields.field' => __('plugins.tl-1menu.setup.fields.field'),
    'fields.label' => __('plugins.tl-1menu.setup.fields.label'),
    'fields.location_ids' => __('plugins.tl-1menu.setup.fields.location_ids'),
    'fields.categories' => __('plugins.tl-1menu.setup.fields.categories'),
    'fields.code' => __('plugins.tl-1menu.setup.fields.code'),
    'fields.kind' => __('plugins.tl-1menu.setup.fields.kind'),
    'fields.category' => __('plugins.tl-1menu.setup.fields.category'),
    'fields.icon' => __('plugins.tl-1menu.setup.fields.icon'),
    'fields.de' => __('plugins.tl-1menu.setup.fields.de'),
    'fields.en' => __('plugins.tl-1menu.setup.fields.en'),
    'fields.actions' => __('plugins.tl-1menu.setup.fields.actions'),
    'actions.remove' => __('plugins.tl-1menu.setup.actions.remove'),
    'actions.add_price_group' => __('plugins.tl-1menu.setup.actions.add_price_group'),
    'actions.add_location' => __('plugins.tl-1menu.setup.actions.add_location'),
    ...
    'prompts.food_type' => __('plugins.tl-1menu.setup.prompts.food_type'),
    'prompts.token' => __('plugins.tl-1menu.setup.prompts.token'),
    'prompts.category' => __('plugins.tl-1menu.setup.prompts.category'),
    'mapping.id' => __('plugins.tl-1menu.setup.mapping.id'),
    'mapping.date' => __('plugins.tl-1menu.setup.mapping.date'),
    'mapping.mensa_name' => __('plugins.tl-1menu.setup.mapping.mensa_name'),
    'mapping.location_id' => __('plugins.tl-1menu.setup.mapping.location_id'),
    'mapping.location_name' => __('plugins.tl-1menu.setup.mapping.location_name'),
    'mapping.type_id' => __('plugins.tl-1menu.setup.mapping.type_id'),
    'mapping.type_name' => __('plugins.tl-1menu.setup.mapping.type_name'),
    'mapping.spalte' => __('plugins.tl-1menu.setup.mapping.spalte'),
    'mapping.allergen_codes' => __('plugins.tl-1menu.setup.mapping.allergen_codes'),
    'mapping.title_de' => __('plugins.tl-1menu.setup.mapping.title_de'),
    'mapping.description_de' => __('plugins.tl-1menu.setup.mapping.description_de'),
    'mapping.title_en' => __('plugins.tl-1menu.setup.mapping.title_en'),
    'mapping.description_en' => __('plugins.tl-1menu.setup.mapping.description_en'),
    'mapping.token_fields' => __('plugins.tl-1menu.setup.mapping.token_fields'),
    'mapping.allergen_names_de' => __('plugins.tl-1menu.setup.mapping.allergen_names_de'),
    'mapping.allergen_names_en' => __('plugins.tl-1menu.setup.mapping.allergen_names_en'),
    'mapping.co2_value' => __('plugins.tl-1menu.setup.mapping.co2_value'),
    'mapping.co2_rating' => __('plugins.tl-1menu.setup.mapping.co2_rating'),
    'mapping.co2_saving' => __('plugins.tl-1menu.setup.mapping.co2_saving'),
    'mapping.water_value' => __('plugins.tl-1menu.setup.mapping.water_value'),
    'mapping.water_rating' => __('plugins.tl-1menu.setup.mapping.water_rating'),
    'mapping.animal_welfare' => __('plugins.tl-1menu.setup.mapping.animal_welfare'),
    'mapping.rainforest' => __('plugins.tl-1menu.setup.mapping.rainforest'),
    'kind.allergen' => __('plugins.tl-1menu.setup.kind.allergen'),
    'kind.additive' => __('plugins.tl-1menu.setup.kind.additive'),
    'kind.category' => __('plugins.tl-1menu.setup.kind.category'),
    'kind.ignore' => __('plugins.tl-1menu.setup.kind.ignore'),
    'status.analyzing' => __('plugins.tl-1menu.setup.status.analyzing'),
    'status.analysis_complete' => __('plugins.tl-1menu.setup.status.analysis_complete'),
    'status.previewing' => __('plugins.tl-1menu.setup.status.previewing'),
    'status.preview_updated' => __('plugins.tl-1menu.setup.status.preview_updated'),
    'status.saving' => __('plugins.tl-1menu.setup.status.saving'),
    'status.saved' => __('plugins.tl-1menu.setup.status.saved'),
    'status.showing_schema' => __('plugins.tl-1menu.setup.status.showing_schema'),
    'status.schema_refreshed' => __('plugins.tl-1menu.setup.status.schema_refreshed'),
    'preview.reload' => __('plugins.tl-1menu.setup.preview_actions.reload'),
    'dialog.cancel' => __('plugins.tl-1menu.setup.dialog.cancel'),
    'dialog.analyze_title' => __('plugins.tl-1menu.setup.dialog.analyze_title'),
    'dialog.save_title' => __('plugins.tl-1menu.setup.dialog.save_title'),
    'dialog.remove_title' => __('plugins.tl-1menu.setup.dialog.remove_title'),
    ...
    'confirm_analyze' => __('plugins.tl-1menu.setup.confirm_analyze'),
    'confirm_remove' => __('plugins.tl-1menu.setup.confirm_remove'),
    'errors.missing_action' => __('plugins.tl-1menu.setup.errors.missing_action'),
    'errors.request_failed' => __('plugins.tl-1menu.setup.errors.request_failed'),
    'errors.empty_key' => __('plugins.tl-1menu.setup.errors.empty_key'),
...
<div class="plugin-settings-card tl1menu-global-settings" data-tl1menu-settings data-tl1menu-setup data-plugin-name="<?= e($plugin->getName()) ?>" data-action-base="<?= e($setupActionBaseUrl) ?>" data-i18n="<?= e(json_encode($setupI18n, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_APOS | JSON_HEX_QUOT) ?: '{}') ?>" data-category-icons="<?= e(json_encode($categoryIconChoices, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_APOS | JSON_HEX_QUOT) ?: '[]') ?>">
    ...
    <fieldset class="full-width">
        <legend><?= e(__('plugins.tl-1menu.global_config.feed_title')) ?></legend>
        <div class="tl1menu-admin-grid">
            <label><?= e(__('plugins.tl-1menu.global_config.menu_url')) ?>
            ...
            <label><?= e(__('plugins.tl-1menu.global_config.cache_ttl')) ?>
            ...
            <label><?= e(__('plugins.tl-1menu.global_config.debug_date')) ?>
    ...
    <fieldset class="full-width">
        <legend><?= e(__('plugins.tl-1menu.global_config.slide_defaults_title')) ?></legend>
        <div class="tl1menu-admin-grid">
            <label><?= e(__('plugins.tl-1menu.config.language')) ?>
                <select name="plugin_global_settings[<?= e($plugin->getName()) ?>][default_language]">
                    <option value="de" <?= selected($defaultLanguage, 'de') ?>><?= e(__('plugins.tl-1menu.languages.de')) ?></option>
                    <option value="en" <?= selected($defaultLanguage, 'en') ?>><?= e(__('plugins.tl-1menu.languages.en')) ?></option>
                </select>
            </label>
            <label><?= e(__('plugins.tl-1menu.global_config.default_mensa')) ?>
            ...
            <div class="tl1menu-admin-checklist full-width">
                <?php foreach (['default_show_header', 'default_display_co2', 'default_display_water', 'default_display_animal_welfare', 'default_display_rainforest'] as $key): ?>
                    <label class="checkbox-row">
                        ...
                        <span><?= e(__('plugins.tl-1menu.global_config.' . $key)) ?></span>
                    </label>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <fieldset class="full-width">
        ...
        <div class="tl1menu-admin-grid">
            ...
            <?php foreach (['co2', 'water', 'animal_welfare', 'rainforest'] as $iconKey): ?>
                <label><?= e(__('plugins.tl-1menu.global_config.environment_icons.' . $iconKey)) ?>
            ...
            <div class="tl1menu-setup__preview-panel" data-tl1menu-preview-panel>
                <div class="tl1menu-setup__preview-head">
                    <div class="tl1menu-setup__preview-tabs" role="tablist" aria-label="<?= e(__('plugins.tl-1menu.setup.preview_tabs_label')) ?>">
                        <button type="button" class="tl1menu-setup__preview-tab is-active" data-tl1menu-preview-tab="schema" role="tab" aria-selected="true"><?= e(__('plugins.tl-1menu.setup.tabs.schema')) ?></button>
                        <button type="button" class="tl1menu-setup__preview-tab" data-tl1menu-preview-tab="test" role="tab" aria-selected="false"><?= e(__('plugins.tl-1menu.setup.tabs.test')) ?></button>
                    </div>
...
<script src="<?= e(url('/plugin-assets/' . $plugin->getName() . '/assets/tl-1menu-setup.js')) ?>"></script>
